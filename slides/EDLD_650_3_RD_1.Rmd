...
.large[
1. Roadmap and Goals (9:00-9:05)
2. DD in panel data (9:05-9:30)
2. Analyzing Liebowitz, Porter & Bragg (9:30-10:15)
3. How DARE you? (10:15-10:30)
  - Questions?
4. Break (10:30-10:45)
5. Regression discontinuity (10:45-11:40)
...
3. Discuss in group conceptual questions (15 min)
...
.large[Massachusetts, like somee other states (including Oregon until very recently) requires students to pass a test in order to graduate. **How does just passing (or failing affect students)?**]<sup>1</sup>
...
**DARE #1 due 11:59pm, 4/20**
**DARE #2 due 11:59pm, 4/28**
