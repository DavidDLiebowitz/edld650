...
small_cath <- catholic[c(1,17,51,143,1101),c(1, 3, 6, 8, 17)]
small_cath[] <- lapply(small_cath, haven::zap_labels)
DT::datatable(small_cath, fillContainer = FALSE, options = list(pageLength = 5))
