...
--
.blue[**Estimand of interest**]: *effect of using financial aid to attend private school*
...
```
---
## What's wrong with the na&iuml;ve approach?
...
.red-pink[Think about this in the Colombia PACES experiment context. What is the **main outcome**? What is the **endogenous regressor**? What is the **instrument**? Can you write the two-stage equation without consulting the next slide or book?]
...
.red-pink[What is the main outcome? What is the endogenous regressor? What is the instrument? What are the assumptions?]
...
.red-pink[**Can you interpret what this means?**]
...
## .blue[What is our estimand of interest? Do these estimates represent that?]
...
.footnote[[1] Don't forget, .blue[**no defiers**] too.]
...
--
.small[
You will see some rules of thumb about what makes for a strong instrument (e.g., $t_{F}>10$), but recent work has found that with $t$-ratios lower than 100 one should adjust critical value ([Lee et al., 2021](https://www.nber.org/papers/w29124)).
]
