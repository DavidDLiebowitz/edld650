...
---
# IV results - First Stage
```{r, echo=F, highlight.output=12}
summary(tot2, stage = 1)
```

.small[
You will see some common rules of thumb about what makes for a strong instrument (e.g., $t_{F}>10$), but recent work has found that with $t$-ratios lower than 100 one should adjust critical value ([Lee et al., 2022](https://www.aeaweb.org/articles?id=10.1257/aer.20211063)).
]
