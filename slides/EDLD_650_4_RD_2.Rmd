...
#### 1. DARE #1 Review (9:00-9:30)

#### 2. Roadmap and Goals (9:30-9:35)

#### 3. Discussion Questions (9:35-10:30)
- Murnane and Willett
- Angrist and Lavy
- Dee and Penner

#### 4. Break (10:30-10:40)
#### 5. Applied regression discontinuity (10:40-11:40)
#### 6. Wrap-up (11:40-11:50)
- DARE #2 prep

---
# DARE #1: General comments
...
.large[
1. Form groups of 2 (not your DARE partner)
2. Independently review DARE #1 model response (5 min)
...
gg_srd <- ggplot() +
geom_vline(xintercept = 60, color = slate, linewidth = 1, alpha = 0.1) +
