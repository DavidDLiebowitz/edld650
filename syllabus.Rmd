...
Office Hours: Wednesdays, 9:00am - 10:30am or by appointment. On Zoom (for now). Sign up on Canvas from 9:00-10:00; drop-in last 30 minutes.
...
Murnane, R.J. & Willet, J.B. (2011). *Methods Matter: Improving Causal Inference in Educational and Social Science Research*. New York: Oxford University Press.
...
We favor projects that will lead ultimately to a scholarly product that can appear on your CV. This includes, but is not limited to conference presentations, published papers, proposals, qualifying papers, a dissertation. In order to ensure that you make an early start and continue to make progress on your project, you must submit an initial one page overview of your proposed project to us by **January 28 at 9:00am**. You will make a public presentation of your project to other class members on **March 8**. Your final written project is due **March 17 at 9:00am**. You will have the opportunity to receive extended written comments on one (1) draft of your written project. You may submit your written project by March 10 at 9:00am and will receive extended comments that will help you revise your work for your final paper. If you choose this option, you will receive general comments on your final draft.

3.	Course Participation (15 points):
You will be assessed on your contribution to the intellectual community of the class via your weekly class participation. Students who share answers that are generally responsive to the prepared prompts and engage respectfully in the classroom community on a regular basis should expect to earn 13 or 14 points. Consistently insightful responses, questions and participation will be awarded 15 points. We do not anticipate that this level of performance will be the norm. Participation that is consistently inaccurate, indicative of a lack of preparation, or marred by frequent, unexcused absences will result in a score of 12 points or fewer. 
